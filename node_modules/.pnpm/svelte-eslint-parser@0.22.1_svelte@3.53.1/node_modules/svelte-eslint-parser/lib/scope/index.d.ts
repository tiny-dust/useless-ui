 ...
 */
export declare function getInnermostScopeFromNode(scopeManager: ScopeManager, currentNode: ESTree.Node): Scope;
/**
 ...
 * @returns The innermost scope.
 */
export declare function getInnermostScope(initialScope: Scope, node: ESTree.Node): Scope;
/** Remove variable */
